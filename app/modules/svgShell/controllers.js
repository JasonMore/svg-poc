(function() {
  angular.module('svgShell')
    .controller('svgShellCtrl', function ($scope){
      ...
      //hack
      $('#svgDiv').svg({onLoad: drawIntro, settings: { height: 600, width: 600}});
      ...
      $('.btnEdit').click(function (event) {
        ...
        var text = svg.text($('#' + g), 0,0, textSpans,
          {id: svgText.id, container:svgText.getAttribute('container'), opacity: 0.7, fontFamily: 'Verdana', fontSize: '20.0', fill:
            'blue'});
